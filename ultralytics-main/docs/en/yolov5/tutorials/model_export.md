...
python valid.py --weights yolov5s.torchscript    # TorchScript
python valid.py --weights yolov5s.onnx           # ONNX Runtime or OpenCV DNN with dnn=True
python valid.py --weights yolov5s_openvino_model # OpenVINO
python valid.py --weights yolov5s.engine         # TensorRT
python valid.py --weights yolov5s.mlmodel        # CoreML (macOS Only)
python valid.py --weights yolov5s_saved_model    # TensorFlow SavedModel
python valid.py --weights yolov5s.pb             # TensorFlow GraphDef
python valid.py --weights yolov5s.tflite         # TensorFlow Lite
python valid.py --weights yolov5s_edgetpu.tflite # TensorFlow Edge TPU
python valid.py --weights yolov5s_paddle_model   # PaddlePaddle
```
