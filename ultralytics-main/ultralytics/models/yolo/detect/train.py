...
class DetectionTrainer(BaseTrainer):
    ...
    for object detection including datasets building, data loading, preprocessing, and model configuration.
    ...
    def get_dataloader(self, dataset_path: str, batch_size: int = 16, rank: int = 0, mode: str = "train"):
        ...
        Args:
            ...
            mode (str): 'train' for training dataloader, 'valid' for validation dataloader.
