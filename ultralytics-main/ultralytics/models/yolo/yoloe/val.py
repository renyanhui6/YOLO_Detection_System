...
class YOLOEDetectValidator(DetectionValidator):
    ...
    def get_vpe_dataloader(self, data: dict[str, Any]) -> torch.utils.data.DataLoader:
        ...
        This method prepares a dataloader for visual prompt embeddings (VPE) using the specified datasets.
        It applies necessary transformations including LoadVisualPrompt and configurations to the datasets
        ...
        dataset = build_yolo_dataset(
            self.args,
            data.get(self.args.split, data.get("valid")),
            self.args.batch,
            data,
            mode="valid",
            rect=False,
    ...
    def __call__(
        ...
        model. For visual prompts, reference data can be specified to extract embeddings from a different datasets.
