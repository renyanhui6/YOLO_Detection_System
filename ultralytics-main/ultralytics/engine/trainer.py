...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        # Update "-1" devices so post-training valid does not repeat search
    ...
    def _setup_train(self):
        ...
        if RANK in {-1, 0}:
            ...
            self.test_loader = self.get_dataloader(
                self.data.get("valid") or self.data.get("test"),
    ...
    def validate(self):
        """
        Run validation on valid set using self.validator.
        ...
        for f in self.last, self.best:
            if f.exists():
                if f is self.last:
                    ...
                    self.validator.args.compile = False  # disable final valid compile as too slow
