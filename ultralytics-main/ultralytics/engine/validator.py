...
"""
Check a model's accuracy on a test or valid split of a datasets.

Usage:
    $ yolo mode=valid model=yolo11n.pt data=coco8.yaml imgsz=640

Usage - formats:
    $ yolo mode=valid model=yolo11n.pt                 # PyTorch
...
class BaseValidator:
    ...
    def __init__(self, dataloader=None, save_dir=None, args=None, _callbacks=None):
        ...
        if self.args.conf is None:
            self.args.conf = 0.01 if self.args.task == "obb" else 0.001  # reduce OBB valid memory usage
